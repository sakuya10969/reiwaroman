...
const TopsRotator = () => {
  ...
  return (
    <div className="relative w-full min-h-[45vw] lg:min-h-[100vh]">
      <div className={[ "absolute inset-0 transition-opacity duration-1500 ease-linear", isCatch ? "opacity-100" : "opacity-0"].join(" ")}>
        <TopsCatch />
      </div>

      <div className={[ "relative w-full min-h-[45vw] lg:min-h-[100vh] transition-opacity duration-1500 ease-linear", isVisual ? "opacity-100" : "opacity-0"].join(" ")}>
